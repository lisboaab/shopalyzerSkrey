...
const NavBar: React.FC = () => {
  ...
  return (
    <div
      className={`bg-main w-fit text-white justify-between p-5 sticky top-0 z-100 h-lvh flex flex-1 flex-col items-center ${
        isMenuOpen ? "translate-x--1" : "translate-x-0"
          ...
          >
            <div className="my-4 flex flex-col justify-start gap-8">
              <h1 className="text-black">
                This action can not be undone and you will loose this
                information forever!
              </h1>
              ...
              <div className="flex justify-end items-center gap-4 border-t border-gray-200 pt-5">
                ...
                <ButtonAnimation
                  ...
                  action={() => {
                    if (selectedSearchId) {
                      handleRemoveSearch(selectedSearchId);
                    }
                  }}
                  width="10em"
                />

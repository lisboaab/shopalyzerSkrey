...
export const updateUser = async (id: string, input: { email?: string; password?: string; name?: string; notifications?: boolean, profilePicture?: string, cloudinaryID?: string }) => {
  try {
    const { data } = await apolloClient.mutate({
